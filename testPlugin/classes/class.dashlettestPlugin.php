...
class dashlettestPlugin implements DashletInterface
{
  const version = '1.0';
  ...
  public function render($width = 300)
  {
    ...
    ///////
    $dashletView = new dashlettestPluginView($arrayUser, $this->note);
...
class dashlettestPluginView extends Smarty
{
  private $smarty;
  ...
  public function __construct($u, $n)
  {
    ...
    $this->smarty->templateFile = PATH_PLUGINS . "testPlugin" . PATH_SEP . "views" . PATH_SEP . "dashlettestPlugin.html";
  }
