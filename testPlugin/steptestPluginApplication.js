Ext.namespace("steptestPlugin");

steptestPlugin.application = {
  init:function(){
    storeApplicationProcess = function () {
      ...
      Ext.Ajax.request({
        url: "../testPlugin/steptestPluginApplicationAjax",
        method: "POST",
...
Ext.onReady(steptestPlugin.application.init, steptestPlugin.application);